    ...
    <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                ...
                <input class="form-control" type="text" value="1000" name="total_amount" readonly="">
                </li>
            </ul>
        </div>
        <div class="col-md-8 order-md-1">
            ...
            <!-- Automatically fill in registered user's details -->
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="thana"id="thana" placeholder="1234 Main St"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="village" name="village"value="{{ Auth::user()->village}}" placeholder="Apartment or suite">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="post_office" class="form-control" id="post_office" value="{{ Auth::user()->post_office}}" placeholder="" required>
                        <div class="invalid-feedback">
                        </div>
                    </div>
                </div>
